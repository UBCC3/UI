...
DROP TABLE IF EXISTS AVAILABLE_CALCULATIONS;
DROP TABLE IF EXISTS AVAILABLE_METHODS;
DROP TABLE IF EXISTS AVAILABLE_BASIS_SETS;
DROP TABLE IF EXISTS available_solvent_effects;
DROP TABLE IF EXISTS WAVE_THEORY;
...
CREATE TABLE AVAILABLE_BASIS_SETS(
    ID SERIAL PRIMARY KEY,
    NAME VARCHAR(255) NOT NULL
);
